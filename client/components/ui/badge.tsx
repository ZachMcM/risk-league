  ...
  "web:inline-flex items-center rounded-full border border-border px-2.5 py-0.5 web:transition-colors web:focus:outline-none web:focus:ring-2 web:focus:ring-ring web:focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        destructive:
          "border bg-destructive/10 border-destructive/20 web:hover:opacity-80 active:opacity-80",
        success:
          "border bg-success/10 border-success/20 border web:hover:opacity-80 active:opacity-80",
