import { LeagueDepthCharts, PositionDepthChart } from "../types/dataFeeds"

export async function dataFeedsReq(route: string, queryParams?: Record<string, string | number | boolean>) {
