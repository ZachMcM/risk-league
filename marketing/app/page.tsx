          ...
          <div className="flex flex-col items-center space-y-8 text-center">
            ...
            <div className="space-y-4 max-w-4xl">
              ...
              <p className="mx-auto max-w-[700px] text-muted-foreground text-lg md:text-xl">
                ...
                financial risk. Build parlays, battle opponents, and climb the
                ELO rankings in the ultimate skill-based gaming experience.
              </p>
            </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="text-center space-y-8">
            <div className="space-y-4">
              ...
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">
                Stay Connected with <span className="gradient-text">Risk League</span>
              </h2>
              <p className="mx-auto max-w-[600px] text-muted-foreground text-lg">
                Join our growing community for the latest updates, tips, and behind-the-scenes content.
              </p>
            </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="text-center space-y-8">
            <div className="space-y-4">
              ...
              <p className="mx-auto max-w-[600px] text-muted-foreground text-lg">
                Join thousands of players waiting to experience the future of sports betting.
              </p>
            </div>
