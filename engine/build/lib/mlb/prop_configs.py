...
from shared.prop_generation.base import (
    DataScope,
    FeatureDefinition,
    ModelType,
    PropConfig,
)
from shared.prop_generation.registry import mlb_registry, register_mlb_stat
...
def home_runs_config() -> PropConfig:
    ...
    return PropConfig(
        ...
        features=[
            ...
            FeatureDefinition(
                "opp_pitching_home_runs", "pitching_home_runs", DataScope.OPPONENT_TEAM
            ),
            FeatureDefinition(
                "opp_pitching_strikeouts",
                "pitching_strikeouts",
                DataScope.OPPONENT_TEAM,
            ),
            FeatureDefinition(
                "opp_pitching_walks", "pitching_walks", DataScope.OPPONENT_TEAM
            ),
        ],
...
def doubles_config() -> PropConfig:
    ...
    return PropConfig(
        ...
        features=[
            ...
            FeatureDefinition("batting_avg", "batting_avg", DataScope.PLAYER),
            FeatureDefinition(
                "opp_pitching_hits", "pitching_hits", DataScope.OPPONENT_TEAM
            ),
            FeatureDefinition(
                "opp_pitching_strikeouts",
                "pitching_strikeouts",
...
def strikeouts_config() -> PropConfig:
    ...
    return PropConfig(
        ...
        features=[
            ...
            FeatureDefinition(
                "opp_pitches_thrown", "pitches_thrown", DataScope.OPPONENT_TEAM
            ),
            FeatureDefinition(
                "opp_pitching_hits", "pitching_hits", DataScope.OPPONENT_TEAM
            ),
...
def pitching_strikeouts_config() -> PropConfig:
    ...
    return PropConfig(
        ...
        features=[
            ...
            FeatureDefinition(
                "opp_batting_avg", "batting_avg", DataScope.OPPONENT_TEAM
            ),
        ],
...
def pitches_thrown_config() -> PropConfig:
    ...
    return PropConfig(
        ...
        features=[
            FeatureDefinition("innings_pitched", "innings_pitched", DataScope.PLAYER),
            FeatureDefinition(
                "pitching_strikeouts", "pitching_strikeouts", DataScope.PLAYER
            ),
            ...
            FeatureDefinition(
                "opp_slugging_pct", "slugging_pct", DataScope.OPPONENT_TEAM
            ),
...
def earned_runs_config() -> PropConfig:
    ...
    return PropConfig(
        ...
        features=[
            ...
            FeatureDefinition("pitching_walks", "pitching_walks", DataScope.PLAYER),
            FeatureDefinition(
                "pitching_home_runs", "pitching_home_runs", DataScope.PLAYER
            ),
            FeatureDefinition("opp_runs", "runs", DataScope.OPPONENT_TEAM),
            FeatureDefinition("opp_ops", "ops", DataScope.OPPONENT_TEAM),
            FeatureDefinition(
...
def pitching_walks_config() -> PropConfig:
    ...
    return PropConfig(
        ...
        features=[
            ...
            FeatureDefinition(
                "opp_on_base_pct", "on_base_pct", DataScope.OPPONENT_TEAM
            ),
